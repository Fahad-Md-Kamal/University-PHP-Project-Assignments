<?php include_once "templates/head.php" ?>
  ...
  <div class="container">
    ...
    <div class="row">
      ...
      <div id="sign_up" class="col-sm-12 col-lg-8 offset-lg-2">

              <div class="jumbotron bg-success text-light">
          <h1 class="h1"> <i class="fas fa-shield-alt"></i> Curious Cybersecurity</h1>
            ...
            <div class="row">
                <div class="col-md-6">
                    ...
                    <form action="php_GetStart.php" method="post">
                        ...
                        <input id="tc" type="checkbox" name="tc" value="1"> <label for="tc"> &nbsp; I agree <a class="text-dark" onclick="agr();" href="#">Terms & Conditions</a></label>
   ...
   <div class="row">
    ...
    <div class="col-12 text-center mb-5"><a class="btn btn-outline-warning" href="ourApproch.php"><p class="h1">Book Course</p></a></div>
      ...
      <div class="col-sm-10 offset-sm-1 my-4 text-center">
        <div class="card h-100">
          <a class="display-4 text-info" href="#"><i class="fas fa-trophy"></i></a>
          <div class="card-body">
            <h4 class="card-title">
              Awards
            </h4>
