...
<div class="mb-5 d-flex col-12 justify-content-center">
    <form class="form-inline my-2" action="services.php" method="get">
      <input class="form-control mr-sm-2" type="text" name="search" placeholder="Search resarch papers" aria-label="Search">
    ...
    <div class="col-sm-12 col-md-4 mt-sm-2 mt-md-0">
        <ul class="list-group list-group-flush">
            ...
            <li class="list-group-item"><a href="services.php">Location</a></li>
        </ul>
    </div>
